        ...
        fluidRow(
          box(width=12, height = 420,
              div(id="about2", class="about",
                  ...
                  p("You can retrieve the variable name usable in the",HTML("<span class=\"fLetter\">phisWSClientR get()</span>")," functions in the observationVariableId colname of each dataset")
              )
          ),
