...
* Enter a __username, password, server and port address__ if you want a __tags$span(style="color:green", "private access")__ to the phenomeapi WS
* Keep the default username and password if you want a __tags$span(style="color:green", "public access")__ to the WS
